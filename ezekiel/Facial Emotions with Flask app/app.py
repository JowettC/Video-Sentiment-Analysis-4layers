...
def upload():
    if request.method == 'POST':
        ...
        negative = (result.count('angry') + result.count('disgust') + result.count('fear') + result.count('sad'))/4
        ...
        ax.pie(temp_counts, labels = temp_emotions,autopct='%1.2f%%')   #adding pie chart
        img = io.BytesIO()
